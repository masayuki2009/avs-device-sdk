...
#ifndef ALEXA_CLIENT_SDK_NXMEDIAPLAYER_INCLUDE_NXMEDIAPLAYER_ISTREAMSOURCE_H_
#define ALEXA_CLIENT_SDK_NXMEDIAPLAYER_INCLUDE_NXMEDIAPLAYER_ISTREAMSOURCE_H_
...
private:
    ...
    virtual ssize_t readData(void *buffer, size_t size);
